...
Reads Online Retail Excel from raw_data/Online Retail.xlsx, transforms, and loads into data_warehouse_notebook/retail_dw.db
"""
...
def find_project_root() -> Path:
    ...
    markers = ["utils", "raw_data", ".git", "data_warehouse_notebook"]
    p = cwd
    for _ in range(10):
...
def main():
    ...
    db_path = root / 'data_warehouse_notebook' / 'retail_dw.db'
